...
public class ActorServices : IActorServices
{
    ...
    public ActorServices(DeltaXDBContext context, IMapper mapper)
    {
        _context = context;
        _mapper = mapper;
    }
    ...
    public ResponseStatus<IEnumerable<ActorDTO>> GetActorsListAsync()
    {
        try
        {
            var actorsData = _mapper.Map<IEnumerable<ActorDTO>>(_context.TblActors);
    ...
    public ResponseStatus<ActorDTO> AddActor(ActorDTO actorDTO)
    {
        try
        {
            var actorsData = _mapper.Map<TblActor>(actorDTO);
            _context.TblActors.Add(actorsData);
